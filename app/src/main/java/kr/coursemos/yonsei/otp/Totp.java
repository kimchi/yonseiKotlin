...
package kr.coursemos.yonsei.otp;
...
public class Totp {
	...
	public static void main(String[] args) {
		System.out.println(Base32.encode("2e411f42041ff608cbff6b116266d920".getBytes()));
		
		System.out.println(new Totp("GJCTIMJRIY2DEMBUGFDEMNRQHBBUERSGGZBDCMJWGI3DMRBZGIYA").now());
